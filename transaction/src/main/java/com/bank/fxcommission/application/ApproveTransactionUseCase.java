...
public class ApproveTransactionUseCase
    implements UseCase<ApproveTransactionUseCaseDto, Transaction> {
  ...
  public Transaction execute(ApproveTransactionUseCaseDto dto) {
    ...
    this.accountFacade.updateBaseAccountBalance(
        transaction.getSourceAccountId(), transaction.getAmountInBaseCurrency());
    this.accountFacade.updateDestinationAccountBalance(
        transaction.getDestinationAccountId(), transaction.getAmountInQuoteCurrency());
